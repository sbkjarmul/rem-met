...
const CleaningHeroSection = () => {
  ...
  return (
    <section className="relative mih-h-[600px] md:min-h-[600px] flex justify-center items-center py-32 md:py-40 gap-4 bg-black">
      <Container className="z-1 flex flex-col justify-end items-start h-full gap-20">
        <div className="gap-6 flex flex-col w-2/3 max-w-md md:max-w-4xl items-start">
          <div className="text-left gap-2 flex flex-col ">
            <AccentText className="text-brand-blue-200 text-start">
              {t("hero.accent")}
            </AccentText>
            <h1 className="text-3xl md:text-5xl font-medium text-gray-200 ">
              ...
              <span className="block md:hidden text-start">
                {t("hero.title.mobile")}
              </span>
            </h1>
          </div>

          <p className="text-gray-500  whitespace-pre-line text-left">
            <span className="hidden md:block text-lg">
              {t("hero.description")}
            </span>
            <span className="block md:hidden text-left text-md">
      ...
      <div className="absolute top-0 left-0 w-full h-[100%] z-0">
        <Image
          src="/images/services/rem-met-cleaning-background.webp"
