...
const GeckoHeroSection = () => {
  ...
  return (
    <section className="flex flex-col justify-end relative bg-gray-400 md:bg-gradient-to-b from-gray-400 from-[75%] to-[80%] to-white min-h-[600px] md:min-h-screen gap-10">
